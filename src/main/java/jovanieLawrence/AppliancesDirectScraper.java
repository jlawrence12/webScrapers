 ...
 */
public class AppliancesDirectScraper extends Thread  {
    ...
    public void run(){
        ...
        while(runThread){
            ...
            System.out.println("The Appliances Direct thread is currently scraping data.");
            try{
            doc = Jsoup.connect("https://www.appliancesdirect.co.uk/search-results/mobiles%20phones").get();
